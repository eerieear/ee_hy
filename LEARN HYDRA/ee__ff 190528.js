...
osc(1,1,0.2)
  .color(()=>a.fft[0]*6,()=>a.fft[6]*3,()=>a.fft[3]*1)
  .rotate(1,0.5)
...
\
osc(1,1,0.2)\
  .color(()=>a.fft[0]*6,()=>a.fft[3]*3,()=>a.fft[3]*1).rotate(1,0.5)\
  .modulateRotate(o1).mult(o1,1)\
  .diff(o2).mult(o2).out()\
osc(12,()=>a.fft[0]*0.01)\
  .kaleid(100)\
  .modulate(noise(()=>a.fft[0]*2))\
  .modulate(o1).diff(o3)\
  .out(o1)\
shape(100,0.01,1).scale(0.6,0.6)\
  .modulateScale(osc(()=>a.fft[0]*4),1))\
	.scale(()=> a.fft[5]*0.2 -4)\
 	 .diff(o1)\
  	.out(o2)\
\
